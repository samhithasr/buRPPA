...
smallAstro = generateUniqueRandomNumbers([astrocytomaNumbers(1), astrocytomaNumbers(end)], 6, []);
smallMeningioma = generateUniqueRandomNumbers([meningiomaNumbers(1), meningiomaNumbers(end)], 6, []);
smallControl = generateUniqueRandomNumbers([controlNumbers(1), controlNumbers(end)], 6, []);
smallOligoDen = generateUniqueRandomNumbers([oligodenNumbers(1), oligodenNumbers(end)], 6, []);
smallOligoAstro = generateUniqueRandomNumbers([oligoastroNumbers(1), oligoastroNumbers(end)], 6, []);
smallColumnVector = [smallAstro.'; smallMeningioma.'; smallControl.'; smallOligoDen.'; smallOligoAstro.'];

% Create three groups
group1 = [smallAstro(1:2), smallMeningioma(1:2), smallControl(1:2), smallOligoDen(1:2), smallOligoAstro(1:2)];
group2 = [smallAstro(3:4), smallMeningioma(3:4), smallControl(3:4), smallOligoDen(3:4), smallOligoAstro(3:4)];
group3 = [smallAstro(5:6), smallMeningioma(5:6), smallControl(5:6), smallOligoDen(5:6), smallOligoAstro(5:6)];
